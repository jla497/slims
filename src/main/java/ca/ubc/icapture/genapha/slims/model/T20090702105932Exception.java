...
/**
 * T20090702105932Exception generated by hbm2java
 */
@Entity
@Table(name="T20090702_105932_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20090702105932Exception  implements java.io.Serializable {


     private T20090702105932ExceptionId id;

    public T20090702105932Exception() {
    }

    public T20090702105932Exception(T20090702105932ExceptionId id) {
       this.id = id;
    }
    ...
    public T20090702105932ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20090702105932ExceptionId id) {
        this.id = id;
    }
