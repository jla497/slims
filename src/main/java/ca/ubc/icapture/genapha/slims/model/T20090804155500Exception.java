...
/**
 * T20090804155500Exception generated by hbm2java
 */
@Entity
@Table(name="T20090804_155500_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20090804155500Exception  implements java.io.Serializable {


     private T20090804155500ExceptionId id;

    public T20090804155500Exception() {
    }

    public T20090804155500Exception(T20090804155500ExceptionId id) {
       this.id = id;
    }
    ...
    public T20090804155500ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20090804155500ExceptionId id) {
        this.id = id;
    }
