...
/**
 * TblmaterialtypeMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLMATERIALTYPE_META_DATA"
    ,schema="ALLERGEN"
)
public class TblmaterialtypeMetaData  implements java.io.Serializable {


     private TblmaterialtypeMetaDataId id;

    public TblmaterialtypeMetaData() {
    }

    public TblmaterialtypeMetaData(TblmaterialtypeMetaDataId id) {
       this.id = id;
    }
    ...
    public TblmaterialtypeMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblmaterialtypeMetaDataId id) {
        this.id = id;
    }
