...
/**
 * TblmaterialtypesMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLMATERIALTYPES_META_DATA"
    ,schema="ALLERGEN"
)
public class TblmaterialtypesMetaData  implements java.io.Serializable {


     private TblmaterialtypesMetaDataId id;

    public TblmaterialtypesMetaData() {
    }

    public TblmaterialtypesMetaData(TblmaterialtypesMetaDataId id) {
       this.id = id;
    }
    ...
    public TblmaterialtypesMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblmaterialtypesMetaDataId id) {
        this.id = id;
    }
