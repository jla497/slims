...
/**
 * TblcontrolMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLCONTROL_META_DATA"
    ,schema="ALLERGEN"
)
public class TblcontrolMetaData  implements java.io.Serializable {


     private TblcontrolMetaDataId id;

    public TblcontrolMetaData() {
    }

    public TblcontrolMetaData(TblcontrolMetaDataId id) {
       this.id = id;
    }
    ...
    public TblcontrolMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblcontrolMetaDataId id) {
        this.id = id;
    }
