...
/**
 * T20091006115754Exception generated by hbm2java
 */
@Entity
@Table(name="T20091006_115754_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20091006115754Exception  implements java.io.Serializable {


     private T20091006115754ExceptionId id;

    public T20091006115754Exception() {
    }

    public T20091006115754Exception(T20091006115754ExceptionId id) {
       this.id = id;
    }
    ...
    public T20091006115754ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20091006115754ExceptionId id) {
        this.id = id;
    }
