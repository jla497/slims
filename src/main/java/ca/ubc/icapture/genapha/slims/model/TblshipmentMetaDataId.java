...
/**
 * TblshipmentMetaDataId generated by hbm2java
 */
@Embeddable
public class TblshipmentMetaDataId  implements java.io.Serializable {
    ...
    public TblshipmentMetaDataId() {
    }

	
    public TblshipmentMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblshipmentMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblshipmentMetaDataId) ) return false;
		 TblshipmentMetaDataId castOther = ( TblshipmentMetaDataId ) other; 
