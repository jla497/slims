...
/**
 * TblcontainertypesMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLCONTAINERTYPES_META_DATA"
    ,schema="ALLERGEN"
)
public class TblcontainertypesMetaData  implements java.io.Serializable {


     private TblcontainertypesMetaDataId id;

    public TblcontainertypesMetaData() {
    }

    public TblcontainertypesMetaData(TblcontainertypesMetaDataId id) {
       this.id = id;
    }
    ...
    public TblcontainertypesMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblcontainertypesMetaDataId id) {
        this.id = id;
    }
