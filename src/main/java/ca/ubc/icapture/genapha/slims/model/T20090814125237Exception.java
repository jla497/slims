...
/**
 * T20090814125237Exception generated by hbm2java
 */
@Entity
@Table(name="T20090814_125237_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20090814125237Exception  implements java.io.Serializable {


     private T20090814125237ExceptionId id;

    public T20090814125237Exception() {
    }

    public T20090814125237Exception(T20090814125237ExceptionId id) {
       this.id = id;
    }
    ...
    public T20090814125237ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20090814125237ExceptionId id) {
        this.id = id;
    }
