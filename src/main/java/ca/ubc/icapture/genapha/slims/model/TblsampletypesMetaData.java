...
/**
 * TblsampletypesMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSAMPLETYPES_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsampletypesMetaData  implements java.io.Serializable {


     private TblsampletypesMetaDataId id;

    public TblsampletypesMetaData() {
    }

    public TblsampletypesMetaData(TblsampletypesMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsampletypesMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsampletypesMetaDataId id) {
        this.id = id;
    }
