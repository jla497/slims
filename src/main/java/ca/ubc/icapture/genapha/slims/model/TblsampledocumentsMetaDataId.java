...
/**
 * TblsampledocumentsMetaDataId generated by hbm2java
 */
@Embeddable
public class TblsampledocumentsMetaDataId  implements java.io.Serializable {
    ...
    public TblsampledocumentsMetaDataId() {
    }

	
    public TblsampledocumentsMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblsampledocumentsMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblsampledocumentsMetaDataId) ) return false;
		 TblsampledocumentsMetaDataId castOther = ( TblsampledocumentsMetaDataId ) other; 
