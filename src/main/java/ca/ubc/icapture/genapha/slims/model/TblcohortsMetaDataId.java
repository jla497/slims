...
/**
 * TblcohortsMetaDataId generated by hbm2java
 */
@Embeddable
public class TblcohortsMetaDataId  implements java.io.Serializable {
    ...
    public TblcohortsMetaDataId() {
    }

	
    public TblcohortsMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblcohortsMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblcohortsMetaDataId) ) return false;
		 TblcohortsMetaDataId castOther = ( TblcohortsMetaDataId ) other; 
