...
/**
 * TblsimsusersMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSIMSUSERS_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsimsusersMetaData  implements java.io.Serializable {


     private TblsimsusersMetaDataId id;

    public TblsimsusersMetaData() {
    }

    public TblsimsusersMetaData(TblsimsusersMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsimsusersMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsimsusersMetaDataId id) {
        this.id = id;
    }
