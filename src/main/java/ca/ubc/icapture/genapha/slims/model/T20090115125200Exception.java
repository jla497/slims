...
/**
 * T20090115125200Exception generated by hbm2java
 */
@Entity
@Table(name="T20090115_125200_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20090115125200Exception  implements java.io.Serializable {


     private T20090115125200ExceptionId id;

    public T20090115125200Exception() {
    }

    public T20090115125200Exception(T20090115125200ExceptionId id) {
       this.id = id;
    }
    ...
    public T20090115125200ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20090115125200ExceptionId id) {
        this.id = id;
    }
