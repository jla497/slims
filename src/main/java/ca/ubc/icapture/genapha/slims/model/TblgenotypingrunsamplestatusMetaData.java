...
/**
 * TblgenotypingrunsamplestatusMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLGENOTYPINGRUNSAMPLESTATUS_META_DATA"
    ,schema="ALLERGEN"
)
public class TblgenotypingrunsamplestatusMetaData  implements java.io.Serializable {


     private TblgenotypingrunsamplestatusMetaDataId id;

    public TblgenotypingrunsamplestatusMetaData() {
    }

    public TblgenotypingrunsamplestatusMetaData(TblgenotypingrunsamplestatusMetaDataId id) {
       this.id = id;
    }
    ...
    public TblgenotypingrunsamplestatusMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblgenotypingrunsamplestatusMetaDataId id) {
        this.id = id;
    }
