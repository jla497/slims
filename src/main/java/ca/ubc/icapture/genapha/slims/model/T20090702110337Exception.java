...
/**
 * T20090702110337Exception generated by hbm2java
 */
@Entity
@Table(name="T20090702_110337_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20090702110337Exception  implements java.io.Serializable {


     private T20090702110337ExceptionId id;

    public T20090702110337Exception() {
    }

    public T20090702110337Exception(T20090702110337ExceptionId id) {
       this.id = id;
    }
    ...
    public T20090702110337ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20090702110337ExceptionId id) {
        this.id = id;
    }
