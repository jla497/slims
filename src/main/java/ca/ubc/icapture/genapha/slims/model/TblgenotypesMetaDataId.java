...
/**
 * TblgenotypesMetaDataId generated by hbm2java
 */
@Embeddable
public class TblgenotypesMetaDataId  implements java.io.Serializable {
    ...
    public TblgenotypesMetaDataId() {
    }

	
    public TblgenotypesMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblgenotypesMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblgenotypesMetaDataId) ) return false;
		 TblgenotypesMetaDataId castOther = ( TblgenotypesMetaDataId ) other; 
