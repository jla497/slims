...
/**
 * TblsampledocumentsMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSAMPLEDOCUMENTS_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsampledocumentsMetaData  implements java.io.Serializable {


     private TblsampledocumentsMetaDataId id;

    public TblsampledocumentsMetaData() {
    }

    public TblsampledocumentsMetaData(TblsampledocumentsMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsampledocumentsMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsampledocumentsMetaDataId id) {
        this.id = id;
    }
