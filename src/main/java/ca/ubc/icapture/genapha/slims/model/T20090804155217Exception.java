...
/**
 * T20090804155217Exception generated by hbm2java
 */
@Entity
@Table(name="T20090804_155217_EXCEPTION"
    ,schema="ALLERGEN"
)
public class T20090804155217Exception  implements java.io.Serializable {


     private T20090804155217ExceptionId id;

    public T20090804155217Exception() {
    }

    public T20090804155217Exception(T20090804155217ExceptionId id) {
       this.id = id;
    }
    ...
    public T20090804155217ExceptionId getId() {
        return this.id;
    }
    
    public void setId(T20090804155217ExceptionId id) {
        this.id = id;
    }
