...
/**
 * TblsnpMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSNP_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsnpMetaData  implements java.io.Serializable {


     private TblsnpMetaDataId id;

    public TblsnpMetaData() {
    }

    public TblsnpMetaData(TblsnpMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsnpMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsnpMetaDataId id) {
        this.id = id;
    }
