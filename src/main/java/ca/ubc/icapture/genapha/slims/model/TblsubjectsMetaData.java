...
/**
 * TblsubjectsMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSUBJECTS_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsubjectsMetaData  implements java.io.Serializable {


     private TblsubjectsMetaDataId id;

    public TblsubjectsMetaData() {
    }

    public TblsubjectsMetaData(TblsubjectsMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsubjectsMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsubjectsMetaDataId id) {
        this.id = id;
    }
