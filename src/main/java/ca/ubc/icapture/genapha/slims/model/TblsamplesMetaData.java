...
/**
 * TblsamplesMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSAMPLES_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsamplesMetaData  implements java.io.Serializable {


     private TblsamplesMetaDataId id;

    public TblsamplesMetaData() {
    }

    public TblsamplesMetaData(TblsamplesMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsamplesMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsamplesMetaDataId id) {
        this.id = id;
    }
