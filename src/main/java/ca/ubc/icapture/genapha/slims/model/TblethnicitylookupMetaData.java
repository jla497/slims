...
/**
 * TblethnicitylookupMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLETHNICITYLOOKUP_META_DATA"
    ,schema="ALLERGEN"
)
public class TblethnicitylookupMetaData  implements java.io.Serializable {


     private TblethnicitylookupMetaDataId id;

    public TblethnicitylookupMetaData() {
    }

    public TblethnicitylookupMetaData(TblethnicitylookupMetaDataId id) {
       this.id = id;
    }
    ...
    public TblethnicitylookupMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblethnicitylookupMetaDataId id) {
        this.id = id;
    }
