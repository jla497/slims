...
/**
 * TblfreezersMetaDataId generated by hbm2java
 */
@Embeddable
public class TblfreezersMetaDataId  implements java.io.Serializable {
    ...
    public TblfreezersMetaDataId() {
    }

	
    public TblfreezersMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblfreezersMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblfreezersMetaDataId) ) return false;
		 TblfreezersMetaDataId castOther = ( TblfreezersMetaDataId ) other; 
