...
/**
 * T20090804155500 generated by hbm2java
 */
@Entity
@Table(name="T20090804_155500"
    ,schema="ALLERGEN"
)
public class T20090804155500  implements java.io.Serializable {


     private T20090804155500Id id;

    public T20090804155500() {
    }

    public T20090804155500(T20090804155500Id id) {
       this.id = id;
    }
    ...
    public T20090804155500Id getId() {
        return this.id;
    }
    
    public void setId(T20090804155500Id id) {
        this.id = id;
    }
