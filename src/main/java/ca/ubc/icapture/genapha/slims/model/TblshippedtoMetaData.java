...
/**
 * TblshippedtoMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSHIPPEDTO_META_DATA"
    ,schema="ALLERGEN"
)
public class TblshippedtoMetaData  implements java.io.Serializable {


     private TblshippedtoMetaDataId id;

    public TblshippedtoMetaData() {
    }

    public TblshippedtoMetaData(TblshippedtoMetaDataId id) {
       this.id = id;
    }
    ...
    public TblshippedtoMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblshippedtoMetaDataId id) {
        this.id = id;
    }
