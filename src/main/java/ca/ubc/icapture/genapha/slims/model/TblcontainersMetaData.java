...
/**
 * TblcontainersMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLCONTAINERS_META_DATA"
    ,schema="ALLERGEN"
)
public class TblcontainersMetaData  implements java.io.Serializable {


     private TblcontainersMetaDataId id;

    public TblcontainersMetaData() {
    }

    public TblcontainersMetaData(TblcontainersMetaDataId id) {
       this.id = id;
    }
    ...
    public TblcontainersMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblcontainersMetaDataId id) {
        this.id = id;
    }
