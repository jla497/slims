...
/**
 * TblgenotypingruncontainersMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLGENOTYPINGRUNCONTAINERS_META_DATA"
    ,schema="ALLERGEN"
)
public class TblgenotypingruncontainersMetaData  implements java.io.Serializable {


     private TblgenotypingruncontainersMetaDataId id;

    public TblgenotypingruncontainersMetaData() {
    }

    public TblgenotypingruncontainersMetaData(TblgenotypingruncontainersMetaDataId id) {
       this.id = id;
    }
    ...
    public TblgenotypingruncontainersMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblgenotypingruncontainersMetaDataId id) {
        this.id = id;
    }
