...
/**
 * TblmaterialtypesMetaDataId generated by hbm2java
 */
@Embeddable
public class TblmaterialtypesMetaDataId  implements java.io.Serializable {
    ...
    public TblmaterialtypesMetaDataId() {
    }

	
    public TblmaterialtypesMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblmaterialtypesMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblmaterialtypesMetaDataId) ) return false;
		 TblmaterialtypesMetaDataId castOther = ( TblmaterialtypesMetaDataId ) other; 
