...
/**
 * TblcontainertypesMetaDataId generated by hbm2java
 */
@Embeddable
public class TblcontainertypesMetaDataId  implements java.io.Serializable {
    ...
    public TblcontainertypesMetaDataId() {
    }

	
    public TblcontainertypesMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblcontainertypesMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblcontainertypesMetaDataId) ) return false;
		 TblcontainertypesMetaDataId castOther = ( TblcontainertypesMetaDataId ) other; 
