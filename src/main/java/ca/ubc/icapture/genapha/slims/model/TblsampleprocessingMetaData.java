...
/**
 * TblsampleprocessingMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSAMPLEPROCESSING_META_DATA"
    ,schema="ALLERGEN"
)
public class TblsampleprocessingMetaData  implements java.io.Serializable {


     private TblsampleprocessingMetaDataId id;

    public TblsampleprocessingMetaData() {
    }

    public TblsampleprocessingMetaData(TblsampleprocessingMetaDataId id) {
       this.id = id;
    }
    ...
    public TblsampleprocessingMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblsampleprocessingMetaDataId id) {
        this.id = id;
    }
