 ...
 * @author JLee05
 */
public interface EthnicitySearchService {
        List<Tblethnicitylookup> findBySearchTerm(Map<String,String> searchTerms);
        Tblethnicitylookup findBySearchTerm2(String searchTerms);
