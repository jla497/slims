...
/**
 * TblsimsusersMetaDataId generated by hbm2java
 */
@Embeddable
public class TblsimsusersMetaDataId  implements java.io.Serializable {
    ...
    public TblsimsusersMetaDataId() {
    }

	
    public TblsimsusersMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Date created) {
        this.sysid = sysid;
    ...
    public TblsimsusersMetaDataId(int sysid, String propertyName, String shortName, String longName, int viewColumnNumber, int isSortable, int isEditable, int showInReports, int createdBy, Integer modifiedBy, Date created, Date modified, String commentary) {
       this.sysid = sysid;
       this.propertyName = propertyName;
       this.shortName = shortName;
       this.longName = longName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblsimsusersMetaDataId) ) return false;
		 TblsimsusersMetaDataId castOther = ( TblsimsusersMetaDataId ) other; 
