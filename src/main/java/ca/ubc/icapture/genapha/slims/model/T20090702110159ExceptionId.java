...
/**
 * T20090702110159ExceptionId generated by hbm2java
 */
@Embeddable
public class T20090702110159ExceptionId  implements java.io.Serializable {
    ...
    public T20090702110159ExceptionId() {
    }

	
    public T20090702110159ExceptionId(long sampleid, long subjectid, String name) {
        this.sampleid = sampleid;
        this.subjectid = subjectid;
        this.name = name;
    }
    public T20090702110159ExceptionId(long sampleid, long subjectid, String name, Short valid, Integer numcalls, String location, Integer numnocalls, String freezerlocation, Double concentration, Long parent, Integer sampletypeid, Integer sampleprocessid, Long parentid) {
       this.sampleid = sampleid;
       this.subjectid = subjectid;
       this.name = name;
       this.valid = valid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof T20090702110159ExceptionId) ) return false;
		 T20090702110159ExceptionId castOther = ( T20090702110159ExceptionId ) other; 
