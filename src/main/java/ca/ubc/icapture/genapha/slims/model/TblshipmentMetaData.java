...
/**
 * TblshipmentMetaData generated by hbm2java
 */
@Entity
@Table(name="TBLSHIPMENT_META_DATA"
    ,schema="ALLERGEN"
)
public class TblshipmentMetaData  implements java.io.Serializable {


     private TblshipmentMetaDataId id;

    public TblshipmentMetaData() {
    }

    public TblshipmentMetaData(TblshipmentMetaDataId id) {
       this.id = id;
    }
    ...
    public TblshipmentMetaDataId getId() {
        return this.id;
    }
    
    public void setId(TblshipmentMetaDataId id) {
        this.id = id;
    }
